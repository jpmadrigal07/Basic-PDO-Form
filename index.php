...
try {
    ...
    $sql = "INSERT INTO user_1 (first_name, last_name, age, email, mobile, city, address, birthday, credit_card_user, payment_method, shop_location, new_client, date_created) VALUES ('".$_POST["first_name"]."','".$_POST["last_name"]."','".$_POST["age"]."','".$_POST["email"]."','".$_POST["mobile"]."','".$_POST["city"]."','".$_POST["address"]."','".$_POST["birthday"]."','".$_POST["credit_card_user"]."','".$_POST["payment_method"]."','".$_POST["shop_location"]."','".$_POST["new_client"]."',NOW())";
    if ($dbh->query($sql)) {
